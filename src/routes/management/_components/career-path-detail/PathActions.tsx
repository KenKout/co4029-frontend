  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        onOpenChange={(open) => {
          if (!open) actions.setConfirming(null);
        }}
        title={
          actions.confirming === "archive"
            ? t("management_career_path_detail.dialogs.archive_title")
            : t("management_career_path_detail.dialogs.publish_title")
        }
        description={
          actions.confirming === "archive"
            ? t("management_career_path_detail.dialogs.archive_description")
            : t("management_career_path_detail.dialogs.publish_description")
        }
        confirmLabel={
          actions.confirming === "archive"
        ...
        confirmVariant={
          actions.confirming === "archive" ? "destructive" : "default"
        }
        onConfirm={
          actions.confirming === "archive"
