  ...
  return (
    <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,7fr)_minmax(0,3fr)]">
          ...
          <SettingsSaveBar
            ...
            onReset={() => {
              void confirm({
                ...
                confirmLabel: t("teacher_quiz_manage.settings.reset_button"),
        ...
        <Card>
          <CardContent>
            <SettingsSection
              ...
              description={t(
                "teacher_quiz_manage.settings.feedback.description",
              )}
            >
              <FeedbackBandsPanel
                quizId={quizId}
                locked={locked || saving || overrideBusy}
                onDirtyChange={onFeedbackDirtyChange}
                onBusyChange={setFeedbackBusy}
              />
            </SettingsSection>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            >
              <OverridesPanel
                ...
                courseId={courseId}
                base={savedDraft}
                locked={locked || saving || feedbackBusy}
                onDirtyChange={onOverrideDirtyChange}
      ...
      <aside className="min-w-0 xl:sticky xl:top-36">
        <SettingsSummary draft={deferredDraft} dirty={dirty} />
      </aside>
      {dialog}
    </div>
  );
