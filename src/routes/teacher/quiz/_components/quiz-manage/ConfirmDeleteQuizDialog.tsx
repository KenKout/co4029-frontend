...
/**
 * Delete-quiz confirmation. Kept as the page's own overlay (not the shared
 * ConfirmDialog) so the copy, icon treatment and pending spinner stay exactly
 * as they were.
 *
 * Extracted from quiz-manage.tsx verbatim.
 */
export function ConfirmDeleteQuizDialog({
  pending,
  onCancel,
  onConfirm,
}: {
