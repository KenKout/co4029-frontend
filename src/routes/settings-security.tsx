...
import DisableSection from "./_components/settings-security/DisableSection";
import EnrollSection from "./_components/settings-security/EnrollSection";
import RegenerateSection from "./_components/settings-security/RegenerateSection";
