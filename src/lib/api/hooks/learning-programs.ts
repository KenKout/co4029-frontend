...
export function useManagedLearningPrograms(organizationId?: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgram[]>(`/management/learning-programs${suffix}`),
  });
}
...
export function useManagedLearningProgram(id?: string) {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgram>(`/management/learning-programs/${id}`),
    enabled: Boolean(id),
  });
}
...
export function useLearningProgramOptions() {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgramAuthoringOptions>(
        "/management/learning-programs/options",
      ),
  });
}
...
export function useLearningProgramVersions(id?: string) {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgramVersion[]>(
        `/management/learning-programs/${id}/versions`,
      ),
    enabled: Boolean(id),
  });
}
...
export function useLearningProgramVersion(id?: string, versionId?: string) {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgram>(
        `/management/learning-programs/${id}/versions/${versionId}`,
      ),
...
export function useCreateLearningProgram() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["learning-programs", "management"] }),
  });
}
...
export function useUpdateLearningProgram(id: string) {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      void qc.invalidateQueries({
        queryKey: ["learning-programs", "management"],
      });
    },
  });
}
...
export function usePublishLearningProgram(id: string) {
  ...
  return useMutation({
    mutationFn: () =>
      apiPost<LearningProgram>(`/management/learning-programs/${id}/publish`),
    onSuccess: () =>
      void qc.invalidateQueries({ queryKey: ["learning-programs"] }),
  });
}
...
export function useArchiveLearningProgram(id: string) {
  ...
  return useMutation({
    mutationFn: () =>
      apiPost<LearningProgram>(`/management/learning-programs/${id}/archive`),
    onSuccess: () =>
      void qc.invalidateQueries({ queryKey: ["learning-programs"] }),
  });
}
...
export function useProgramRoster(id: string) {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgramEnrollment[]>(
        `/management/learning-programs/${id}/students`,
      ),
    enabled: Boolean(id),
  });
}
...
export function useEnrollProgramStudents(id: string) {
  ...
  return useMutation({
    mutationFn: (studentIds: string[]) =>
      apiPost<LearningProgramEnrollment[]>(
        `/management/learning-programs/${id}/students`,
        {
...
export function useProgramChangeRequests(id: string) {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<PathChangeRequest[]>(
        `/management/learning-programs/${id}/path-change-requests`,
      ),
    enabled: Boolean(id),
  });
}
...
export function useDecidePathChange(programId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      void qc.invalidateQueries({
        queryKey: queryKeys.learningPrograms.requests(programId),
      });
      void qc.invalidateQueries({
        queryKey: queryKeys.learningPrograms.roster(programId),
      });
    },
  });
}
...
export function useMyLearningPrograms() {
  return useQuery({
    ...
    queryFn: () =>
      apiFetch<LearningProgramEnrollment[]>("/me/learning-program-enrollments"),
  });
}
...
export function useSelectProgramPath() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiPost<LearningProgramEnrollment>(
        `/me/learning-program-enrollments/${enrollmentId}/select-path`,
        {
...
export function useRequestProgramPathChange() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiPost<PathChangeRequest>(
        `/me/learning-program-enrollments/${enrollmentId}/path-change-requests`,
        {
          target_career_path_id: pathId,
          from_attempt_id: fromAttemptId ?? null,
          reason,
        },
      ),
    onSuccess: () =>
...
export function useCancelProgramPathChange() {
  ...
  return useMutation({
    mutationFn: (requestId: string) =>
      apiDelete(
        `/me/learning-program-enrollments/path-change-requests/${requestId}`,
      ),
    onSuccess: () =>
      void qc.invalidateQueries({
        queryKey: queryKeys.learningPrograms.mine(),
