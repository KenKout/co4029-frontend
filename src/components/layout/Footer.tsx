        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              Personalizing education through the synergy of artificial
              intelligence and human curiosity. Next-generation learning
              infrastructure.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li>
                ...
                >
                  <MoveRight className="w-3 h-3 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all" />{" "}
                  Course Library
                </Link>
              </li>
              <li>
